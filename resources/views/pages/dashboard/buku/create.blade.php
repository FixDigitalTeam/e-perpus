  ...
  <div class="py-12">
    <div class="max-w-7xl mx-auto sm:px-6 lg:px-60">
      <div>
        ...
        <form action="{{ route('dashboard.buku.store') }}" method="post" enctype="multipart/form-data" class="w-full">
          @csrf
          <div class="flex flex-wrap -mx-3 mb-2">
            <div class="w-full px-3">
              ...
              <input
                ...
                id="judul" name="judul" type="text" value="{{ old('judul') }}" placeholder="Judul">
            </div>
          </div>
          <div class="flex flex-wrap -mx-3 mb-2">
            <div class="w-full px-3">
              ...
              <input
                class="appearance-none block w-full bg-gray-200 text-gray-700 border border-gray-200 rounded py-3 px-4 mb-3 leading-tight focus:outline-none focus:bg-white focus:border-gray-500"
                id="pengarang" name="pengarang" type="text" value="{{ old('pengarang') }}" placeholder="Pengarang">
            </div>
          </div>
          <div class="flex flex-wrap -mx-3 mb-2">
            <div class="w-full px-3">
